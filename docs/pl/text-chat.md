...
Domyślnie wiadomość jest wysyłana, gdy tylko zostanie wpisana. Whisper czasem
przesłyszy, a w sesji publicznej pomyłka jest problemem wszystkich — dlatego
...
Whisper zapisuje to, co słyszy, a nazwiska kierowców to dokładnie to, co wychodzi
mu najgorzej. Wtyczka sesji czyta, kto naprawdę jest w Twojej sesji, i podaje te
