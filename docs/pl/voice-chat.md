...
Discord już istnieje i wszyscy już na jakimś są. Czego Discord nie potrafi, to
wsadzić Cię do pokoju z **kimkolwiek jest w tej sesji**,
...
odpowiedź ma ~16 KB, a aplikacja nigdy nie może czekać na grę w trakcie
...
`endpoints.py` **w czasie budowania**, więc kopia kodu, albo fork, nie ma żadnego
adresu i czat głosowy jest niedostępny. To stan działający — lepszy niż każdy
klon źródeł kierujący mikrofon na serwer, którego właściciel nigdy nie zgodził
się go dźwigać.
...
Czat głosowy jest **wyłączony, dopóki się go nie włączy**, a karta Głos mówi, kto
może Cię usłyszeć, zanim powie cokolwiek innego. Aplikacja, która po cichu
otworzyłaby mikrofon dla dwudziestu obcych, byłaby zdradą, choćby funkcja była
nie wiadomo jak dobra.

Tylko push-to-talk. Nie ma trybu otwartego mikrofonu i nie powinno być:
wyzwalacz jest zgodą.
