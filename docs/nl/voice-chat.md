...
Discord bestaat al en iedereen zit er al in. Wat Discord niet kan, is je in een ruimte
zetten met **wie er ook maar in deze sessie zit**, zonder dat vooraf te regelen, en
degenen die vier kilometer verderop zitten stil te houden.
...
praten. In een raceweekend is dat de beste van de twee.
...
build** in `endpoints.py` geschreven, dus een checkout — of een fork — heeft helemaal
geen adres en spraak is simpelweg niet beschikbaar. Dat is een werkende toestand, geen
kapotte: beter dan dat elke kloon van de broncode een microfoon richt op een server
waarvan de eigenaar nooit heeft ingestemd hem te dragen.
...
relay dat voor de groep gekozen is niet. Geografie is de hele reden dat racers kunnen
hosten. Kosten zijn dat niet, en decentralisatie omwille van zichzelf ook niet.
...
Voicechat staat **uit tot je hem aanzet**, en het tabblad Stem zegt wie je kan horen
