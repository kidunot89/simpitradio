...
**Een stuurknop werkt ook.** Wijs hem met [JoyToKey](https://joytokey.net/) toe
aan een toetsenbordtoets en koppel die toets hier. SimPitRadio leest sturen niet
rechtstreeks uit; de reden staat in
[de aantekeningen van de engineer](engineer.md#instellingen-per-sim): een
Fanatec-krans somde 79 ingangen op en meldde via geen van vier verschillende
bibliotheken ooit een druk, en een Steam Controller überhaupt uitlezen betekende
hem van Steam afpakken.

## Stel je microfoon in

**Audio → Microfoon.** Kies de ingang, houd de trigger vast en kijk naar de
niveaubalk — die toont het signaal *na* versterking, dus wat Whisper werkelijk
krijgt. Mik op pieken rond driekwart.
...
4. Bij het loslaten gaat de clip naar Whisper, op je eigen processor.
...
Niets hieronder staat standaard aan.
