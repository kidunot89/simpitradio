...
O ciclo do acionamento já grava um excerto enquanto a tecla está premida e entrega-o ao
...
acionamento, a resposta tem ~16 KB, e uma aplicação de ditado nunca deve esperar por um jogo
...
`endpoints.py` **em tempo de compilação**, por isso uma
