...
reproduz em vez de falar pelo sintetizador do Windows.
...
*gravados*, e os seus 11 176 nomes de pilotos e 1052 excertos de números foram
...
Um pacote é uma pasta com uma subpasta `voice` lá dentro a guardar os WAV — a
disposição que o `crew-chief-autovoicepack` escreve, por isso **um pacote do Crew
Chief entra diretamente**. A pasta exterior é separada para que um pacote possa
levar uma licença e as suas gravações de origem sem que estas sejam confundidas
com frases.
...
Os nomes de ficheiro vêm da frase, em minúsculas, com a pontuação **retirada** em
