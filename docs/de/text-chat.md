...
Das, wofür SimPitRadio gebaut wurde. Taste halten, sagen, was Sie sagen wollen,
loslassen — und es steht getippt in der Chatbox des Spiels, ohne dass Ihre Hände
das Lenkrad verlassen.

Alles andere in der App ist daraus gewachsen. Der Ingenieur, der Coach und der
Sprachchat teilen sich dieselbe Taste und dieselbe Aufnahme; Textchat ist das,
...
2. **Die Aufnahme startet sofort** — bevor die Chatbox geöffnet wird, nicht
...
4. **Sie lassen los.** Die Aufnahme endet und der Clip geht an Whisper, auf Ihrer
   eigenen CPU.
...
bewusst eng gefasst — siehe [Mit ihm sprechen](engineer.md#mit-ihm-sprechen) — denn
dieselbe Taste schickt Nachrichten an alle in Ihrer Session, und ein Befehl, den
die App erfindet, ist eine Nachricht, die stillschweigend nie ankommt.
...
Standardmäßig wird die Nachricht gesendet, sobald sie getippt ist. Whisper
verhört sich, und in einer öffentlichen Session ist ein Fehler das Problem aller
— darum hat jedes Profil einen Schalter **Automatisch senden**.
...
Manche Spiele ignorieren das, weil sie stattdessen Hardware-Scancodes lesen — für
die wechseln Sie auf *scancode*, das tippt, als wären die Tasten physisch
gedrückt worden.
...
pro Frame lesen. Getippter Text nicht — er läuft über die Nachrichtenschlange,
und 40 ms pro Zeichen ließen eine Nachricht mit 200 Zeichen acht Sekunden
dauern.

## Namen und Vokabular

Whisper transkribiert, was es hört, und Fahrernamen sind genau das, worin es am
schlechtesten ist. Das Session-Plugin liest, wer tatsächlich in Ihrer Session
ist, und speist diese Namen ein, sodass „Estre“ als „Estre“ herauskommt und
nicht als „Ester“.

**Vokabular** ergänzt Ihre eigenen Wörter — Sponsorennamen, einen Teamnamen, die
tatsächliche Schreibweise der Nicknames Ihrer Freunde. Alles, was Sie sich immer
wieder korrigieren sehen, lohnt sich einzutragen.
...
sich *Letzter Auslöser* nie, liegt es an der Taste oder am Hook, nicht an der
Transkription.
